...
int main(int argc, char** argv)
{
  ...
  HL_MD5    digestMd5;
  HL_SHA1   digestSha1;
  HL_SHA256 digestSha2;
  HL_Keccak digestKeccak(HL_Keccak::Keccak256);
  HL_SHA3   digestSha3  (HL_SHA3  ::Bits256);
  ...
  // each cycle processes about 1 MByte (divisible by 144 => improves HL_Keccak/HL_SHA3 performance)
  ...
  if (computeMd5)
    std::cout << "HL_MD5:        " << digestMd5   .getHash() << std::endl;
  if (computeSha1)
    std::cout << "HL_SHA1:       " << digestSha1  .getHash() << std::endl;
  if (computeSha2)
    std::cout << "SHA2/256:   " << digestSha2  .getHash() << std::endl;
  if (computeKeccak)
    std::cout << "HL_Keccak/256: " << digestKeccak.getHash() << std::endl;
  if (computeSha3)
    std::cout << "HL_SHA3/256:   " << digestSha3  .getHash() << std::endl;
